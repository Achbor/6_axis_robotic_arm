...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2/ros2_arm/src/robotic_arm/robotic_arm_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2/ros2_arm/install/robotic_arm_moveit_config/share/robotic_arm_moveit_config/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='robotic_arm_280',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'robotic_arm_description'
    urdf_filename = 'robotic_arm_280.urdf.xacro'
    rviz_config_filename = 'robot_arm.rviz'
