...
def generate_launch_description():
    ...
    package_name_gazebo = 'robotic_arm_gazebo'
    package_name_description = 'robotic_arm_description'
    package_name_moveit = 'robotic_arm_moveit_config'

    default_robot_name = 'robotic_arm_280'
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        description='World file name (e.g., empty.world, house.world, pick_and_place.world)')
